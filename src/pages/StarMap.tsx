...
const StarMap = () => {
  ...
  return (
    <div className="min-h-screen relative py-8 px-4">
      <motion.h1 
        className="text-center text-3xl md:text-4xl lg:text-5xl font-playfair text-white mb-12 mt-4"
          ...
          >
            ...
            >
              <div 
                ...
                cursor-pointer shadow-[0_0_15px_rgba(155,135,245,0.5)]"
                onClick={() => setSelectedMemory(memory)}
              />
              <motion.div 
                className="absolute opacity-0 group-hover:opacity-100 -top-10 left-1/2 -translate-x-1/2 
                bg-black/60 backdrop-blur-sm rounded-md px-3 py-1.5 min-w-[100px] text-center 
                border border-constellation-purple/20 shadow-[0_0_10px_rgba(155,135,245,0.2)]
